...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$assign = __webpack_require__(82)['default'];

	var _regeneratorRuntime = __webpack_require__(32)['default'];

	var _interopRequireDefault = __webpack_require__(87)['default'];

	Object.defineProperty(exports, '__esModule', {
		value: true
	});

	var _co = __webpack_require__(88);
	...
	var _fevent = __webpack_require__(90);
	...
	var Core = (function (_Dispatcher) {
			...
			if (typeof window == 'undefined') {
				...
				if (window.Fluky) {
					if (window.Fluky.state) {
						this._state = _Object$assign({}, window.Fluky.state);
					}
				}
			}
		...
		_createClass(Core, [{
					...
					return _regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
						while (1) switch (context$3$0.prev = context$3$0.next) {
							...
							case 9:
								...
								console.log(context$3$0.t3.stack);
			...
			key: 'setState',
			value: function setState(stateName, state) {

				if (!this._state[stateName]) this._state[stateName] = state;else this._state[stateName] = _Object$assign(this._state[stateName], state);
			}
		}, {
			key: 'state',
			get: function get() {
						...
						return _regeneratorRuntime.wrap(function callee$3$0$(context$4$0) {
							while (1) switch (context$4$0.prev = context$4$0.next) {
								...
								case 10:
									...
									if (!(context$4$0.t2.message != 'document is not defined' || context$4$0.t2.stack.indexOf('at getActiveElement') == -1)) {
										context$4$0.next = 15;
										break;
									}
